...
/*   Updated: 2023/08/28 22:21:44 by dbrandao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
p name>.cub\n"
# define E_MAP_INVALID "Error\nMap file does not exist or has incorrect \
permissions\n"
...
# define E_MORE_PLAYERS "Error\nIncorrect number of specific characters in \
the map\n"
...
# define E_TEXTURE_INVALID "Error\nTexture file does not exist or has \
